...
model= tf.keras.Sequential([
    ...
    tf.keras.layers.Dropout(0.18),
    tf.keras.layers.MaxPooling1D(2),
    tf.keras.layers.Bidirectional(tf.keras.layers.GRU(128, return_sequences=True,kernel_initializer=tf.keras.initializers.GlorotUniform(seed=SEED))),
    tf.keras.layers.Dropout(0.25, seed=SEED),
    tf.keras.layers.Bidirectional(tf.keras.layers.GRU(64,kernel_initializer=tf.keras.initializers.GlorotUniform(seed=SEED))),
    tf.keras.layers.Dropout(0.25, seed=SEED),
    tf.keras.layers.Flatten(),
